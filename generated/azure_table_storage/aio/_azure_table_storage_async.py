...
from ._configuration_async import AzureTableStorageConfiguration
...
class AzureTableStorage(object):
    ...
    :vartype table: azure_table_storage.aio.operations_async.TableOperations
    :ivar service: ServiceOperations operations
    :vartype service: azure_table_storage.aio.operations_async.ServiceOperations
    ...
    async def __aenter__(self) -> "AzureTableStorage":
