...
class TableOperations:
    ...
    async def query(
        ...
        **kwargs
        ...
        """
        cls: ClsType["models.TableQueryResponse"] = kwargs.pop('cls', None )
    ...
    async def create(
        ...
        **kwargs
        ...
        """
        cls: ClsType["models.TableResponse"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
    ...
    async def query_entities(
        ...
        **kwargs
        ...
        :raises: ~azure_table_storage.models.StorageErrorException:
        """
        cls: ClsType["models.TableEntityQueryResponse"] = kwargs.pop('cls', None )
        error_map = kwargs.pop('error_map', {})
    ...
    async def set_access_policy(
        ...
        timeout: Optional[int] = None,
        request_id: Optional[str] = None,
        table_acl: Optional[List["SignedIdentifier"]] = None,
        **kwargs
    ) -> None:
