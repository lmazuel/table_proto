...
class ServiceOperations(object):
    ...
    def set_properties(
        self,
        storage_service_properties,  # type: "models.StorageServiceProperties"
    ...
    def get_statistics(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.StorageServiceStats"
        ...
        :raises: ~azure_table_storage.models.StorageErrorException:
        """
        cls = kwargs.pop('cls', None )  # type: ClsType["models.StorageServiceStats"]
        error_map = kwargs.pop('error_map', {})
        restype = "service"
        comp = "stats"
